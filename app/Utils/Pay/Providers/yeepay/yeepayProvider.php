<?php
namespace App\Utils\Pay\Providers\yeepay;

use App\Utils\Pay\Providers\Provider;
use App\Utils\Logger;
class yeepayProvider extends Provider
{
    ...
    function getApiUrl()
    {
        return "http://merchant.e9bill.com/gateway/bank.aspx";
    }

    function notify_url(){
        return $this->getConfig('host')."notify/yeepay";
    }
    ...
    function pay_force()
    {
        ...
        return $this->getHttpClient()->post($this->getApiUrl(),$params);
    }
    ...
    private function _hmacMd5($data,$key, $iconv = false){
        //Logger::with('pay')->error($data);
        //if($iconv){
